...
osTextModule.service("ListService", [
    "TextService", "XsltService", function(
        ...
        addListLayer : function(layerId) {
            ...
            TextService.content(
                XsltService.indentToString(
                    XsltService.transformString("/js/text/Layer.add.xsl", TextService.content(), {
                        "layer-type" : "list",
        ...
        renameListLayer : function(oldId, newId) {
            ...
            TextService.content(
                XsltService.indentToString(
                    XsltService.transformString("/js/text/Layer.rename.xsl", TextService.content(), {
                        "old-layer-id" : oldId,
                        "new-layer-id" : newId
                    }), TextService._isFlat
                )
        ...
        removeListLayer : function(layerId) {
            ...
            TextService.content(
                XsltService.indentToString(
                    XsltService.transformString("/js/text/Layer.remove.xsl", TextService.content(), {
                        "layer-id" : layerId
                    }), TextService._isFlat
                )
            );
